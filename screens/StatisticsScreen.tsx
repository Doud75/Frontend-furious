  ...
  return (
    <View style={[globalStyles.background, styles.page]}>
      <View style={styles.tabs}>
        ...
        >
            <Text style={[globalStyles.paragraph, styles.tabText]}>Mes statistiques</Text>
        </TouchableOpacity>
        <TouchableOpacity 
          style={[styles.tabButton, tab === "general" && styles.tabButtonActive]} 
          onPress={() => handleTab("general")}
        >
            <Text style={[globalStyles.paragraph, styles.tabText]}>Statistiques globales</Text>
        </TouchableOpacity>
      </View>
      {tab === "perso" && (
        <UserStatistics 
