...
const ColorChoice: React.FC = () => {
  const [selectedColor, setSelectedColor] = useState<ColorTuple | undefined>(
    undefined,
  );
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={[globalStyles.paragraph, styles.paragraph]}>
        Personnalise les couleurs des leds de ta voiture pour un maximum de
        style !
      </Text>
        ...
        {colorsLed.map((color, index) => {
          return (
            <TouchableOpacity
              ...
              style={[
                styles.button,
                selectedColor === color && styles.buttonActive,
              ]}
              onPress={() => handlePress(color)}>
              <View
                style={[styles.round, {backgroundColor: color.hexa}]}></View>
              <Text style={[globalStyles.paragraph, styles.textButton]}>
                {color.color}
              </Text>
            </TouchableOpacity>
          );
